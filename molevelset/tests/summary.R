...
TestSummaryList <- function() {
    ...
    expected <- structure(list(total_cost = -2.31276695516712, gamma = 0, k.max = 2, 
                               rho = 0.05, delta = 0.05, total.cost = -2.31276695516712, 
                               num.boxes = 1, num.inset.boxes = 1L, num.non.inset.boxes = 0L, 
                               num.points = 10L), .Names = c("total_cost", "gamma", "k.max", 
                                                      "rho", "delta", "total.cost", "num.boxes", "num.inset.boxes", 
                                                      "num.non.inset.boxes", "num.points"))
